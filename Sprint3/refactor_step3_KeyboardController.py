        ...
        if frame is not None:
            ...
            if selected_name == "Disable":
                if not self.joystick_controller.joystick_running:
                    self.joystick_controller.start()
            # else:
            #     if self.joystick_controller.joystick_running:
                ...
                if self.tracked_points is None:
                    ...
                    if selected_name != "Disable":
                        ...
                        def recognize_faces_thread():
                            ...
                            face_locations, face_names, face_confidences, face_distances = self.face_recognizer.recognize_faces(frame, target_encodings, target_names)
